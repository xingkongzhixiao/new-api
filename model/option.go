...
func InitOptionMap() {
	...
	common.OptionMap["UserGroupDiscount"] = ratio_setting.UserGroupDiscount2JSONString()
	common.OptionMap["ChannelGroupRatio"] = ratio_setting.ChannelGroupRatio2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "UserGroupDiscount":
		err = ratio_setting.UpdateUserGroupDiscountByJSONString(value)
	case "ChannelGroupRatio":
		err = ratio_setting.UpdateChannelGroupRatioByJSONString(value)
